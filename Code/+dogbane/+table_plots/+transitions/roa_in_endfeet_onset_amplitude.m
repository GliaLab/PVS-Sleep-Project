function roa_in_endfeet_onset_amplitude(tbl_roa_in_endfeet_transitions)
...
I = ismember(tbl_roa_in_endfeet_transitions.state,{'is:awakening','rem:awakening','nrem:awakening'});
tbl_roa_in_endfeet_transitions = tbl_roa_in_endfeet_transitions(I,:);
...
i_start = begonia.util.val2idx(-20,t);
i_end = begonia.util.val2idx(-10,t);
