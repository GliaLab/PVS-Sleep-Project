function roa_frequency_in_endfeet_per_roi(tbl_roa_in_endfeet,roi_group)
output_folder = '~/Desktop/bar_plots/roa_frequency_in_endfeet_per_roi';

base_filename   = sprintf('roa_freq_%s',roi_group);
plot_title      = sprintf('ROA frequency in %s',roi_group);
