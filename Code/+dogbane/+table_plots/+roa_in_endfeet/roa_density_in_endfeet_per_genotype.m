function roa_density_in_endfeet_per_genotype(tbl_roa_in_endfeet,genotype)
output_folder = '~/Desktop/bar_plots/';
output_folder = fullfile(output_folder,'roa_density_in_endfeet_per_genotype');

base_filename   = sprintf('roa_density_%s',genotype);
plot_title      = sprintf('ROA density in %s',genotype);
