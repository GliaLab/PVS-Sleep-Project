function roa_density_in_endfeet_per_roi(tbl_roa_in_endfeet,roi_group)
output_folder = '~/Desktop/bar_plots/roa_density_in_endfeet_per_roi';

base_filename   = sprintf('roa_density_%s',roi_group);
plot_title      = sprintf('ROA density in %s',roi_group);
plot_y_label    = 'ROA density';
response        = 'roa_density';
...
tbl_roa_in_endfeet.genotype = setcats(tbl_roa_in_endfeet.genotype,{'wt_dual','ip3_dual'});
...
tbl_roa_in_endfeet.roi_group = setcats(tbl_roa_in_endfeet.roi_group,{roi_group});
