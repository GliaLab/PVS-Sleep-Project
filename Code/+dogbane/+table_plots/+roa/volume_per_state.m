function volume_per_state(tbl)

output_folder = '~/Desktop/sleep_project/bar_plots/roa_volume_per_state';

genotype = 'wt_dual';

base_filename   = sprintf('volume_%s',genotype);
plot_title      = sprintf('ROA volume in %s',genotype);
