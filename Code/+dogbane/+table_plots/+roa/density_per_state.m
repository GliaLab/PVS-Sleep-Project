function density_per_state(tbl)
output_folder = '~/Desktop/sleep_project/bar_plots/roa_density_per_state';

genotype = 'wt_dual';

base_filename   = sprintf('density_%s',genotype);
plot_title      = sprintf('ROA density in %s',genotype);
plot_y_label    = 'ROA density';

response        = 'highpass_thresh_roa_density';
predictor       = 'state';
