function duration_per_state(tbl)

output_folder = '~/Desktop/sleep_project/bar_plots/roa_duration_per_state';

genotype = 'wt_dual';

base_filename   = sprintf('duration_%s',genotype);
plot_title      = sprintf('ROA duration in %s',genotype);
plot_y_label    = 'ROA duration (s)';
