function size_per_state(tbl)

output_folder = '~/Desktop/sleep_project/bar_plots/roa_size_per_state';

genotype = 'wt_dual';

base_filename   = sprintf('size_%s',genotype);
plot_title      = sprintf('ROA size in %s',genotype);
plot_y_label    = 'ROA size (um^2)';
