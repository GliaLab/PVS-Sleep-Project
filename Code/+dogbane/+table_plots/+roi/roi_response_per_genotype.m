function roi_response_per_genotype(tbl,genotype)
output_folder = '~/Desktop/bar_plots/roi_response_per_genotype';

base_filename   = sprintf('roi_response_%s',genotype);
plot_title      = sprintf('ROI average df/f0 in %s',genotype);
plot_y_label    = 'df/f0';
...
tbl.roi_group = setcats(tbl.roi_group,{'AS','Gp'});
