function plot_roa_vol_distribution_freq(trial)
...
for i = 1:height(roa_distributions)
    x = roa_distributions.roa_vol_bin_edges(i,2:end);
    y = roa_distributions.roa_vol_N_norm(i,:) * 100 * 60;
...
title(sprintf('ROA Frequency by Volume'),'interpreter','none');
