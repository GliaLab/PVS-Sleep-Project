...
for i = 1:length(scans)
    ...
    color_table.ep(color_table.ep == "Locomotion") = "Clean Locomotion";
    color_table.ep(color_table.ep == "Whisking") = "Clean Whisking";
    color_table.ep(color_table.ep == "Quiet") = "Clean Quiet";
    color_table.ep(color_table.ep == "Awakening") = "Clean Awakening";
    ...
    % Save
    filename = fullfile(eustoma.get_plot_path, "Linescan Vessel Images Figures All", vessel_name);
