classdef ChannelRotation < roiman.ViewModule
    properties
        channel
        matkey
        cdatakey
    ...
    methods
        function obj = ChannelRotation(name, channel)
        ...
        function on_init(obj, manager, view)
            ...
            m_flag_on = ["current_frame", "tseries","rotation"];
            v_flag_on = ["channel", "viewport", "channel_mode", "channel_samples", "channel_xy_smoothing", "channel_colormap", "channel_low", "channel_high"];
        ...
        function on_update(obj, manager, view)
            ...
            rotation = m_read("rotation");
            data = imrotate(data,rotation,'nearest','crop');
